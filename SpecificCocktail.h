...
protected:
    std::string alcoholDescription; /**< The description of the added alcohol. */

public:
    /**
     * @brief Construct a new Specific Cocktail object.
     * 
     * @param baseCocktail The base cocktail to add the alcohol to.
     * @param alcohol The type of alcohol to add.
     */
